...
println("POGM RMSE     = ", rmse(x_pogm, xtrue), "  L = ", pogm_L, "  maxiter = ", pogm_maxiter)
````
...
FISTA RMSE    = 0.13023307323610872  γ = 0.00015  maxiter = 1000
POGM RMSE     = 0.13289538783382054  L = 6666.666666666667  maxiter = 1000
